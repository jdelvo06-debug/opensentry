...
## Key Features to Add to OpenSentry

### HIGH PRIORITY (directly improves realism)
1. **C2-style Hook Bubbles** — ALREADY ADDED (track data blocks)
...
16. **Keyboard navigation** — Alt key shortcuts like standard C2 systems
